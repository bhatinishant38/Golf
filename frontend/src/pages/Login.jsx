...
function Logo() {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" className="h-7 w-7">
      ...
      <path fill="url(#dh-logo-3)" d="M16 2.5 28 6.4v9.2c0 6.6-4.6 12.3-12 14.4C8.6 27.9 4 22.2 4 15.6V6.4L16 2.5Z" />
...
function CourseScene() {
  return (
    <svg viewBox="0 0 400 640" preserveAspectRatio="xMidYMid slice" className="h-full w-full" aria-hidden="true">
      <defs>
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-white p-6 sm:p-10">
              ...
              <form className="mt-7 space-y-5" onSubmit={(e) => e.preventDefault()}>
                <div>
                  <label htmlFor="loginEmail" className="block text-sm font-medium text-slate-700">
                    Email address
                  </label>
                  <input
                    id="loginEmail"
